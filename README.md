[![PHP CI](https://github.com/CalledByThe4ire/brain-games/actions/workflows/php-ci.yml/badge.svg)](https://github.com/CalledByThe4ire/brain-games/actions/workflows/php-ci.yml)
